...
opa = Radiobutton(win, text="+", var=op, val=0)
ops = Radiobutton(win, text="-", var=op, val=1)
opm = Radiobutton(win, text="*", var=op, val=2)
opd = Radiobutton(win, text="/", var=op, val=3)

bt = Button(win, text="Evaluate", command=doeval)
